...
%\begin{problemgroup}
    ...
    \end{problem}
    \begin{answer}
        For part (a), the set of finite-order elements of $(\mathbb{R}, +)$ is $\{0\}$. For part (b), the set of finite-order elements of $(\mathbb{R^\times}, \cdot)$ is $\{1, -1\}$ as $(-1)^2=1$. For part (c), the set of finite-order elements contains all $n$-th roots of unity.\footnote{In research I found that finite-order elements are called \emph{torsion elements} and that groups can be classified as a \emph{torsion group} (where every element is a torsion element).}
    \end{answer}
%\end{problemgroup}
%\begin{problemgroup}
    \begin{problem}
